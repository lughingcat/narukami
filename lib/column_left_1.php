<div id="cmaker_column_left_1_wrap" class="cmakerWrapcolumn_left_1 show-element notshow">
	<div class="column_left_1_Prevew">
		<article class="cmakerPrevew">
			...
			<?php
			//array-check
			$column_left_1_bgImg_url_check = isset($_POST['column_left_bg_img_url']) ? $_POST['column_left_bg_img_url'] : "";
			$column_left_1_title_check = isset($_POST['column_left_1_title']) ? $_POST['column_left_1_title'] : "";
			$column_left_1_content_check = isset($_POST['column_left_1_content']) ? $_POST['column_left_1_content'] : "";
			//function-result
			$column_left_1_bgImg_url_result = data_variable_set($column_left_1_bgImg_url_check, $column_left_1_bgImg_url, $gm_numbers);
			$column_left_1_title_result = data_variable_set($column_left_1_title_check, $column_left_1_title, $gm_numbers);
			$column_left_1_content_result = data_variable_set($column_left_1_content_check, $column_left_1_content, $gm_numbers);
			...
			<div class="column_left_1-all-wrap">
				...
				<div class="column_left_1-text-wrap">
					...
					<p class="column_left_1-main-content"><?php echo stripslashes($column_left_1_content_nl2br); ?></p>
				</div>
			</div>
		</article>
	</div>
	...
	<?php
  	generate_upload_image_tag('column_left_bg_img_url', $column_left_1_bgImg_url_result, $insertGlobalId, $gm_numbers);
	?>
	<h4>コンセプトタイトルを入力してください。</h4>
	<input type="text" name="column_left_1_title[<?php echo $gm_numbers; ?>]" class="img-setect-url" value=
		   <?php echo $column_left_1_title_result ;?>
		   >
	<h4>文章を入力してください。</h4>
		<p>※改行せずに入力すると美しく見えます。</p>
	<textarea name="column_left_1_content[<?php echo $gm_numbers; ?>]" class="narukami-tinymce-editor"><?php echo stripslashes($column_left_1_content_result); ?>
	</textarea>
	</div>
