<div id="cmaker_column_right_1_wrap" class="cmakerWrapcolumn_right_1">
	<div class="column_right_1_Prevew">
		<article class="cmakerPrevew">
			<?php
			  require_once(dirname(dirname(dirname(dirname(dirname( __FILE__ ))))) . '/wp-load.php' );
			  global $wpdb;
			  $query = "SELECT column_right_1_bg_img_url,  column_right_1_title, column_right_1_content FROM wp_narukami_content_maker;";
	...
	<div class="inputForm">
		<?php 
			if( !empty($_POST['column_right_1_bg_img_url']) )
			{ 
				$column_right_1_bg_url = $_POST['column_right_1_bg_img_url']; 
			} else{ 
	...
	<input type="text" name="column_right_1_title" class="img-setect-url" value=
		   ...
		   if( isset($_POST['column_right_1_title'])){
			   echo $_POST['column_right_1_title'];
		   }else{
			   echo $column_right_1_title;
		   }
			   ;?>
		   >
	...
	<textarea name="column_right_1_content" class="adm-textarea"><?php
		if( isset($_POST['column_right_1_content'])){
			...
			echo $column_right_1_content;
		}
		;?>
		</textarea>
	</div>
	<button type="button" id="column_right_1CloseBtn">閉じる</button>
</div>