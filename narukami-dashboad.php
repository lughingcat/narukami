					...
					<a>
						<div class="panel-content-wrap">
							...
							<p>
								...
								ヒーローヘッダー画像: 1740 x 1320px 長方形<br>
							...
							<span>注意事項</span><br>
							ヘッダー設定の中にあるサイトアニメーション設定を有効にしている場合、サイトの背景画像は削除してください。アニメーションが正常に動かない場合が御座います。404ページ設定、またはlpページの背景画像はオリジナルの物を設定しても問題なく動作します。
							</p>
						</div>
					</a>
