<article class="n-section-block">
	<div class="column_3-all-wrap">
		...
		<div class="column_3-back-wrap"
			 style="background-image: url(<?php echo $column_three_bg_img_url; ?>)">
		</div>
		...
		<div class="column_3_item_wrap">
		<div class="column_3-back-wrap"
			 style="background-image: url(<?php echo $column_three_sec_bg_img_url; ?>)">
		</div>
		<div class="column_3-text-wrap">
		...
		<div class="column_3_item_wrap">
		<div class="column_3-back-wrap"
			 style="background-image: url(<?php echo $column_three_third_bg_img_url; ?> )">
		</div>
		<div class="column_3-text-wrap">
